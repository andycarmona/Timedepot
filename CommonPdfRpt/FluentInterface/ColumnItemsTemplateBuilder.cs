...
namespace PdfRpt.FluentInterface
{
    ...
    public class ColumnItemsTemplateBuilder
    {
        ...
        /// HtmlField uses the HTMLWorker class of iTextSharp which is deprecated now and you should replace it with XHtmlField.
        /// </summary>
        ...
        {
            _columnItemsTemplate = new HyperlinkField(new BaseColor(foreColor), fontUnderline)
            {
