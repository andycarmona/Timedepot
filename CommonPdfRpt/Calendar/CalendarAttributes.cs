...
namespace PdfRpt.Calendar
{
    ...
    public class CalendarAttributes
    {
        ...
        public CalendarAttributes()
        {
            ...
            GradientStartColor = new BaseColor(Color.LightGray);
            GradientEndColor = new BaseColor(Color.DarkGray);
            Padding = 5;
            UseLongDayNamesOfWeek = true;
            DayNamesRowBackgroundColor = new BaseColor(Color.WhiteSmoke);
        }
    }
}
