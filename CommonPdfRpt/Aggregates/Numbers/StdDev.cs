...
namespace PdfRpt.Aggregates.Numbers
{
    ...
    public class StdDev : IAggregateFunction
    {
        ...
        public void CellAdded(object cellDataValue, bool isNewGroupStarted)
        {
            ...
            _groupStdDev = Math.Sqrt(double.Parse(_varianceFunc.GroupValue.ToSafeString(), CultureInfo.InvariantCulture));
            _ovarallStdDev = Math.Sqrt(double.Parse(_varianceFunc.OverallValue.ToSafeString(), CultureInfo.InvariantCulture));
        }
