...
namespace PdfRpt.HeaderTemplates
{
    ...
    public class DefaultHeaderProvider : IPageHeader
    {
        ...
        public DefaultHeaderProvider()
        {
            ...
            MessageFontColor = new BaseColor(Color.Black);
                ...
                pdfCellAttributesList: new List<CellAttributes>
                    {
                        ...
                        {                      
                            BasicProperties = new CellBasicProperties
                            {
                                ...
                                ShowBorder = false,
                                FontColor = new BaseColor(Color.Black),                            
                        ...
                        new CellAttributes
                        {
                            BasicProperties = new CellBasicProperties
                            {
                                ...
                                HorizontalAlignment = HorizontalAlignment.Center,
                                PdfFont = PdfFont,
                                RunDirection = RunDirection == null ? PdfRunDirection.RightToLeft : RunDirection.Value,
