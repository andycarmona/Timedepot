        ...
        public IPdfReportData CreatePdfReport()
        {
            ...
            .MainTableColumns(columns =>
            {
                ...
                columns.AddColumn(column =>
                {
                    ...
                    {
                        template.TextBlock();
                        template.DisplayFormatFormula(obj => obj == null ? string.Empty : ((DateTime)obj).ToString("MM/dd/yyyy"));
                    });
                });
            ...
            .MainTableEvents(events =>
            {
                ...
                events.RowStartedInjectCustomRows(customRows =>
                {
                    ...
                    customRows.AddRow(newRow =>
                    {
                        ...
                        newRow.AddCell("Id", 1);
                        newRow.AddCell("Date", DateTime.Parse("3/17/2012"));
            ...
            .Generate(data => data.AsPdfFile(string.Format("{0}\\Pdf\\InjectCustomRowsSample-{1}.pdf", AppPath.ApplicationPath, Guid.NewGuid().ToString("N"))));
        }
    }
}
